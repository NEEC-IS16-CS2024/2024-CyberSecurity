...
('root', '[{\"db\":\"webapp\",\"table\":\"users\"},{\"db\":\"information_schema\",\"table\":\"TABLES\"},{\"db\":\"webapp\",\"table\":\"posts\"}]');
...
('root', 'webapp', 'users', '{\"sorted_col\":\"`users`.`user_id` ASC\"}', '2024-11-15 02:56:31');
...
('root', '2024-11-15 03:09:41', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ja\",\"NavigationWidth\":0}');
...
(1, 3, 'test', '2024-11-01 12:00:35', 'test1');
