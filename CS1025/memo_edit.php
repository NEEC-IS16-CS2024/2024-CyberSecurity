...
<body>
    <?php if (isset($_SESSION['user_id'])): ?>
        <form method="post">
            <label>タイトル: <input type="text" name="title" value="<?= htmlspecialchars($memo['post_title']) ?>"
                    maxlength="1000"></label><br>
            <label>内容: <textarea name="content"
                    maxlength="1000"><?= htmlspecialchars($memo['post_text']) ?></textarea></label><br>
